...
@Service
public class NRDServicesProcedureExecutorServiceImpl implements NRDServicesProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(NRDServicesProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("NRDServicesWMProcedureExecutor")
