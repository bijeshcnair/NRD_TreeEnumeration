...
@Service
public class NRDServicesQueryExecutorServiceImpl implements NRDServicesQueryExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(NRDServicesQueryExecutorServiceImpl.class);

    @Autowired
    @Qualifier("NRDServicesWMQueryExecutor")
