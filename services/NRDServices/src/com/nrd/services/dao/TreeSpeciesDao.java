...
/**
 * Specifies methods used to obtain and modify TreeSpecies related information
 * which is stored in the database.
 */
@Repository("NRDServices.TreeSpeciesDao")
public class TreeSpeciesDao extends WMGenericDaoImpl<TreeSpecies, String> {
