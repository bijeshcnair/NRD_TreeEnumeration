...
/**
 * Specifies methods used to obtain and modify BoughtTags related information
 * which is stored in the database.
 */
@Repository("NRDServices.BoughtTagsDao")
public class BoughtTagsDao extends WMGenericDaoImpl<BoughtTags, String> {
