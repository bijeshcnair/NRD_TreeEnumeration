...
import com.nrd.services.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("NRDServices.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/NRDServices/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("NRDServices.EmployeeService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getEmployee(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee editEmployee(@PathVariable("id") String id, @RequestBody Employee employee) throws EntityNotFoundException {
        LOGGER.debug("Editing Employee with id: {}" , employee.getEmployeeName());

        employee.setEmployeeName(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployee(@PathVariable("id") String id) throws EntityNotFoundException {
    ...
    public Page<TreeEnumerations> findAssociatedTreeEnumerationses(@PathVariable("id") String id, Pageable pageable) {
        ...
        return employeeService.findAssociatedTreeEnumerationses(id, pageable);
    }
